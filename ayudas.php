...
?>  
 <table  class ="stream tabla_fondo pl-3" width="900px" >
  ...
  Para buscar los datos de un contribuyente  deberá ingresar la información disponible en los campos de texto <img src="./pics/calle.jpg" width ="225px" height ="25px">.Cuanta mas información ingrese mas preciso será el resultado. Si la busqueda arroja mas de 50 registros deberá ingresar mas datos a fin de reformular la misma.<br><br>
...
<table  class ="stream tabla_fondo pl-3" width="900px" >
  ...
  A continuación presione <img src="./pics/boton_ficha.jpg" width="65px" height ="25px"> de cada visualizar el listado de contribuyentes filtrado según calle y alturas.
  <br>
  <br>
