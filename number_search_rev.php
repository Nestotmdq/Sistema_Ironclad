...
echo "<input type='range' name='max_range_input' step='10' min='0' max='".$number_mayor."' onchange='updTextmax(this.value);'>";
echo "<input type='text' id='max_text_input' value='".$number_mayor."'>";
echo "<br>";
echo "<label for='caja_busqueda2'class ='texto'>ALTURA B</label>";
echo "<input type='range' name='min_range_input' step='10' min='0' max='".$number_mayor."' onchange='updTextmin(this.value);'>";
